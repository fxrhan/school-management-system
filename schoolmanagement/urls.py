"""
by Mikealson Academy kumar
written by fb.com/Mikealson Academy.luv
...
urlpatterns = [
    ...
    path('teacher-semester', views.teacher_semester_view,name='teacher-semester'),
    path('teacher-subject', views.teacher_subject_view,name='teacher-subject'),
    path('teacher-add-subject/<str:cl>', views.teacher_add_subject_view,name='teacher-add-subject'),
    ...
    path('student-semester', views.student_semester_view,name='student-semester'),
    path('student-subject', views.student_subject_view,name='student-subject'),
    path('student-results', views.student_results_view,name='student-result'),
